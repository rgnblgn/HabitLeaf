...
export default function AddHabitScreen() {
  ...
  const NOTIFICATION_TIMES = [
    { label: t("addHabit.morning"), time: "09:00", icon: "🌅" },
    { label: t("addHabit.afternoon"), time: "14:00", icon: "☀️" },
    { label: t("addHabit.evening"), time: "20:00", icon: "🌙" },
  ];
    ...
    <ThemedView style={styles.container}>
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>{t("addHabit.title")}</Text>
          <View style={{ width: 40 }} />
        </View>
      </LinearGradient>
      ...
      >
        ...
        <View style={[styles.previewCard, Shadows.medium]}>
          ...
          <Text style={[styles.previewName, { color: theme.text }]}>
            {name || t("addHabit.habitNamePlaceholder")}
          </Text>
          <Text
            style={[styles.previewFrequency, { color: theme.textSecondary }]}
          >
